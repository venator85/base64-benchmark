...
public class AwsBase64Codec {
    ...
    public AwsBase64Codec() {
        this.alphabets = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".getBytes(StandardCharsets.US_ASCII);
    }

    protected AwsBase64Codec(byte[] alphabets) {
